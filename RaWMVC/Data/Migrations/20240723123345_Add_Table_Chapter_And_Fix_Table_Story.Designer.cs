...
namespace RaWMVC.Data.Migrations
{
    ...
    [Migration("20240723123345_Add_Table_Chapter_And_Fix_Table_Story")]
    partial class Add_Table_Chapter_And_Fix_Table_Story
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("RaWMVC.Data.Entities.Story", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            storyId = new Guid("4c0715f9-8f94-42cc-ae60-9dd7d39f0f3a"),
                            Position = 0,
                            genreId = new Guid("32a29cb8-b605-456d-82f2-76fb5564deee"),
                            publishDate = new DateTime(2024, 7, 23, 19, 33, 44, 785, DateTimeKind.Local).AddTicks(8114),
                            statusId = new Guid("2f85b983-e349-4a46-b829-a77cd30be50f"),
                        ...
                        new
                        {
                            storyId = new Guid("bd6164fb-1fe9-4b3b-bfbb-80decdc28640"),
                            Position = 0,
                            genreId = new Guid("32a29cb8-b605-456d-82f2-76fb5564deee"),
                            publishDate = new DateTime(2024, 7, 23, 19, 33, 44, 785, DateTimeKind.Local).AddTicks(8133),
                            statusId = new Guid("2f85b983-e349-4a46-b829-a77cd30be50f"),
